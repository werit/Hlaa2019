 ...
 * @author msi
 */
public class TCStartToNavigateToItem extends TCMessageData {
    private static final long serialVersionUID = 786632342349123855L;

    public static final IToken MESSAGE_TYPE = Tokens.get("TCStartToNavigateToItem");
    
    private UnrealId who;
    
    private UnrealId what;
        public TCStartToNavigateToItem(UnrealId who, UnrealId what) {
        super(MESSAGE_TYPE);
        this.who = who;
        this.what = what;
    }
