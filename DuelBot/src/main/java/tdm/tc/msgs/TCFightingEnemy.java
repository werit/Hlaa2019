 ...
 * @author msi
 */
public class TCFightingEnemy extends TCMessageData {
	
	private static final long serialVersionUID = 78663234234912157L;

	public static final IToken MESSAGE_TYPE = Tokens.get("TCFightingEnemy");
	
	private UnrealId who;
	
	private UnrealId what;	
	
	public TCFightingEnemy(UnrealId who, UnrealId what) {
		super(MESSAGE_TYPE);
		this.who = who;
		this.what = what;
	}
