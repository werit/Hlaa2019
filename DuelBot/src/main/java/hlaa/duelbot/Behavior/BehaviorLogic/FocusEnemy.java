 ...
 * @author msi
 */
public class FocusEnemy implements IBehavior {
    ...
    public IBehavior Stop() {
        behaviorResource.navigation.setFocus(null);
        return null;
    }

    @Override
    public IBehavior Execute() {
        behaviorResource.navigation.setFocus(behaviorResource.focusedEnemy);
        return this;
    }
